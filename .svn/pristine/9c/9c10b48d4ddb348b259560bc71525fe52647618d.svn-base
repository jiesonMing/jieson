...
Page({
  data: {
    ...
    getGoodsList:function(id){
            var that = this;
            var data = {appid:config.APPID,act:'ajax_goodsInfo',id:id}
            http.httpPost("/goods.php" ,data,function(res){
    ...
    buyNow:function(e){
          ...
          //取出购物车商品
          goods = {id:goods.id,name:goods.title,img:goods.thumb,price:goods.price,buycount:count,isChecked:true};
          try{
